...
to the historical executable. Current workspace crates are 0.5.79. Published
...
cargo test -p saorsa-gossip-pubsub@0.5.79 --all-features --locked --offline
cargo test -p saorsa-gossip-transport@0.5.79 --all-features --lib --locked --offline
```
