...
to the historical executable. Current workspace crates are 0.5.80. Published
...
cargo test -p saorsa-gossip-pubsub@0.5.80 --all-features --locked --offline
cargo test -p saorsa-gossip-transport@0.5.80 --all-features --lib --locked --offline
```
